...
3. In the example, there was only one query parameter so JdbcTemplate was used. Since ResultSetExtractor implements Spring's org.springframework.jdbc.core.ResultSetExtractor it can be used with NameJdbcTemplateMapper/JdbcClient.
