...
6. The collection property on the main object being populated by toMany **always has to be of type 'List'**. In the above example order.orderLines has to be of type List.
