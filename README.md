...
2. [Relationship](https://spring-jdbc-crud.github.io/simplejdbcmapper/javadoc/io/github/simplejdbcmapper/relationship/Relationship.html) works with the query results information provided by the API. It does not access the database or use SimpleJdbcMapper.
