...
A library that simplifies Spring JdbcTemplate/JdbcClient CRUD operations by making them less verbose. Use its API where as needed and keep using JdbcTemplate/JdbcClient for all other functionality.
