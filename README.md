...
3. A [Relationship](https://spring-jdbc-crud.github.io/simplejdbcmapper/javadoc/io/github/simplejdbcmapper/relationship/Relationship.html) is thread safe and can be used with different query results which have the same relationship.
