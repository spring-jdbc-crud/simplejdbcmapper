...
A library that simplifies Spring JdbcTemplate/JdbcClient CRUD operations by making them less verbose. Its a simple wrapper around Spring JDBC libraries. Use its api where beneficial and keep using JdbcTemplate/JdbcClient for all other functionality.
