...
2. [RelationshipMapper](https://spring-jdbc-crud.github.io/simplejdbcmapper/javadoc/io/github/simplejdbcmapper/relationship/RelationshipMapper.html) works with the query results and information provided by the API. It does not access the database or use SimpleJdbcMapper. It just assembles the relationship tree.
