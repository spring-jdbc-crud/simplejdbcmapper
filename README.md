...
3. [Relationship](https://spring-jdbc-crud.github.io/simplejdbcmapper/javadoc/o/github/simplejdbcmapper/relationship/Relationship.html) works with the information provided by the API. It does not access the database or use SimpleJdbcMapper.
