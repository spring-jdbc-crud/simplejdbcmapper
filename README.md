...
4. Self join tables where for example employee and manager both point to same table, you will have to map the manager as a different class and use in queries. Different classes can be mapped to same table see [Table annotation](#annotations).
