 ...
 * 
 * <p>
 * Not thread safe. Needs a new instance to be created for each use.
 * 
			...
			if (propMapping != null) {
				try {
					...
					if (resultSetTyped || value == null) {
						...
						// getResultSetValue() could not extract a typed value. Need to do conversion
						boolean canConvert = conversionService.canConvert(value.getClass(),
