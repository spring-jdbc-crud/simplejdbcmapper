...
class InsertHelper {
	...
	private void populateAutoAssignProperties(TableMapping tableMapping, BeanWrapper bw) {
		if (tableMapping.hasAutoAssignProperties()) {
			...
			if (createdOnPropMapping != null && sjms.getRecordAuditedOnSupplier() != null) {
				bw.setPropertyValue(createdOnPropMapping.getPropertyName(), sjms.getRecordAuditedOnSupplier().get());
			}
			...
			if (createdByPropMapping != null && sjms.getRecordAuditedBySupplier() != null) {
				bw.setPropertyValue(createdByPropMapping.getPropertyName(), sjms.getRecordAuditedBySupplier().get());
			}
	...
	private SimpleJdbcInsert createNewSimpleJdbcInsert(TableMapping tableMapping) {
		SimpleJdbcInsert jdbcInsert = new SimpleJdbcInsert(sjms.getDataSource())
