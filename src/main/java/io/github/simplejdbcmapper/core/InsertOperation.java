...
class InsertOperation {
	...
	public void insert(Object obj) {
		...
		if (tableMapping.isIdAutoGenerated()) {
			...
			// Handle case where driver returned number type is not an exact match to mapped
			// java type. Ex: BigInteger to Integer
	...
	private SimpleJdbcInsert createNewSimpleJdbcInsert(TableMapping tableMapping) {
		SimpleJdbcInsert simpledbcInsert = new SimpleJdbcInsert(sjmSupport.getDataSource())
		...
		simpledbcInsert.includeSynonymsForTableColumnMetaData();
		if (tableMapping.isIdAutoGenerated()) {
			simpledbcInsert.usingGeneratedKeyColumns(tableMapping.getIdColumnName());
		}
		return simpledbcInsert;
	}
