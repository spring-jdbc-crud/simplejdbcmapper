...
public final class SimpleJdbcMapper {
	...
	/**
	 * A row mapper for custom queries for mapped entities.
	 * 
	 * <p>
	...
	public <T> EntityRowMapper<T> getEntityRowMapper(Class<T> entityType) {
		return findOperation.getEntityRowMapper(entityType);
	}

	/**
	 * Gets the columns SQL that works with the EntityRowMapper. EntityRowMapper
