...
public final class SimpleJdbcMapper {
	...
	// Map key - class name
	// value - SimpleJdbcInsertOperations
	private SimpleCache<String, SimpleJdbcInsertOperations> insertSqlCache = new SimpleCache<>();
	...
	public void insert(Object obj) {
		...
		if (!foundInCache) {
			// SimpleJdbcInsertOperations is thread safe.
			insertSqlCache.put(obj.getClass().getName(), jdbcInsert);
		}
	}

	private SimpleJdbcInsertOperations createNewSimpleJdbcInsert(TableMapping tableMapping) {
	...
	SimpleCache<String, SimpleJdbcInsertOperations> getInsertSqlCache() {
